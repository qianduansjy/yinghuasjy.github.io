                                                ...
                                                $(".imgbox .public").eq(6).fadeTo(300, 1, function () {
                                                    ...
                                                    $(".imgbox .public").eq(3).fadeTo(300, 1, function () {
                                                        ...
                                                        $(".imgbox .public").eq(4).fadeTo(300, 1, function () {
                                                            ...
                                                            //熄灭每个盒子
                                                            $(".imgbox .public").eq(0).fadeTo(100, 0, function () {
                                                                //第二个
                                                                $(".imgbox .public").eq(1).fadeTo(100, 0, function () {
                                                                    //第三个
                                                                    $(".imgbox .public").eq(2).fadeTo(100, 0, function () {
                                                                        //第六个
                                                                        $(".imgbox .public").eq(5).fadeTo(100, 0, function () {
                                                                            //第九个
                                                                            $(".imgbox .public").eq(8).fadeTo(100, 0, function () {
                                                                                //第八个
                                                                                $(".imgbox .public").eq(7).fadeTo(100, 0, function () {
                                                                                    //第七个
                                                                                    $(".imgbox .public").eq(6).fadeTo(100, 0, function () {
                                                                                        //第四个
                                                                                        $(".imgbox .public").eq(3).fadeTo(100, 0, function () {
                                                                                            //第五个
                                                                                            $(".imgbox .public").eq(4).fadeTo(100, 0, function () {

                                                                                                $(".imgbox .public").addClass("pub");
                                                                                                $(".imgbox").addClass("lve");
                                                                                                $($(".imgbox .public")[0]).find("a").attr("href","login/login-index.html");
                                                                                                for(var i=1;i<9;i++){
                                                                                                    $($(".imgbox .public")[i]).find("a").attr("href","finds/find/find-2.html");
                                                                                                }
                                                                                                //结束后调用设置动画
                                                                                                setAimate();
