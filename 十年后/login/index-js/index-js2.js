...
for(var i=0;i<data.length;i++){
    ...
    //给txt设置不同的背景图片
    if(i<=5){
        txt.style.background="url(../index-images/dream_success.png) no-repeat left/150px 45px ";
    }else{
        txt.style.background="url(../index-images/dream_process.png) no-repeat left/150px 45px ";
    }
...
txts[index].style.background="url(../index-images/dream_process_hover.png) no-repeat left/150px 45px ";
...
left.onclick=function(){
    if(index>0){
        ...
        for(var i=0;i<txts.length;i++){
            if(i<=5){
                txts[i].style.background="url(../index-images/dream_success.png) no-repeat left/150px 45px ";
            }else{
                txts[i].style.background="url(../index-images/dream_process.png) no-repeat left/150px 45px ";
            }
        }
        if(index>5){
            txts[index].style.background="url(../index-images/dream_process_hover.png) no-repeat left/150px 45px ";
        }else{
            txts[index].style.background="url(../index-images/dream_success_hover.png) no-repeat left/150px 45px ";
        }
...
for(var i=0;i<txts.length;i++){
    ...
    txts[i].onmouseover=function(){
        if(this.index!=index){
            if(this.index<=5){
                this.style.background="url(../index-images/dream_success_hover.png) no-repeat left/150px 45px ";
            }else{
                this.style.background="url(../index-images/dream_process_hover.png) no-repeat left/150px 45px ";
            }
        }
    }
    txts[i].onmouseout=function(){
        if(this.index!=index){
            if(this.index<=5){
                this.style.background="url(../index-images/dream_success.png) no-repeat left/150px 45px ";
            }else{
                this.style.background="url(../index-images/dream_process.png) no-repeat left/150px 45px ";
            }
        }
    }
